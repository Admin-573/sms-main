<html>
            ...
            <table>
                <td>
                    <form action="" method="POST">
                        <button style="margin-right:20px" class="button_signup signup" name="btnSignUp">New Student</button>
                    </form>
                </td>
                <td>
                    <form action="" method="POST">
                        <button class="button_signin signin" name="btnSignIn">Already An Student</button>
                    </form>
                </td>
            </table>
            </p>
    ...
    <?php
        if(isset($_POST['btnSignUp'])){
            ?>
                <script>
                    window.open("http://localhost/sms-main/student_signup.php","_self")
                    </script>
            <?php
        }
        ...
        if(isset($_POST['btnSignIn'])){
            ?>
                <script>
                    window.open("http://localhost/sms-main/student_login.php","_self")
                    </script>
            <?php
        }
    ?>
